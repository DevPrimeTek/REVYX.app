...
## 0a. STATUS EXECUȚIE (LIVE) ★ v1.2.19
...
### ★ Regula 20 — Segregare rent / sale (chirie vs vânzare) (NEW v1.2.19)
...
5. **Notary acts (BRD §6 Deal Closure):** apar **doar pe sale flow** (`buyer/seller` + property `listingType ∈ {'sale', 'both'}`). Rental deals folosesc **lease agreement** ca artifact (scope M1.S6+); pipeline-ul deals și commissions funcționează pe ambele profiles.
...
**Violarea Regulii 20** (UI care arată buget cumpărare la chiriaș; match podium care propune sale property la tenant lead; notary act pe rental deal; filter list care omite tenant/landlord; commission % preț pe rent deal) → finding **HIGH** în HST + corecție obligatorie în PR de remediere.
...
*CLAUDE.md · v1.2.19 · 2026-05 · CONFIDENȚIAL · Uz Intern*
