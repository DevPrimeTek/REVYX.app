...
<!-- INDEX_REVYX_documents_v1.1.0.md · v1.1.0 · 2026-07 -->
...
| ★ `docs/MASTER_PLAN_REVYX_execution-roadmap_v1.1.1.md` | PATCH S15-bis-3 — Trio canonical introduction. §0 Status Tracker ★ S19 update (S18 ✅ → S19 ✅; next S20 HST #2 MANDATORY). Backwards compat full cu v1.1.0. Versiunea **activă**. Approval §13 pending S20 close. |
...
## 12. Document count summary (S19 close, v1.1.0)
...
| Workflows | 11 |
| Runbooks | 11 |
| Audit + Readiness | 17 (★ +1: CHECKLIST_pre-hst2 v1.0.0) |
| CS Playbooks + Checklists | 7 |
| Legal | 7 |
| Test fixtures + Templates | 3 |
| Skills | 5 |
| **Board reports + Strategic post-GA** ★ §15 NEW | 1 (★ RAPORT_FINAL_BOARD_phase5-ga v1.0.0) |
| **Total** | **106 documente** (incl. patch + minor versions; +2 vs v1.0.9 = 1 RAPORT_FINAL_BOARD + 1 CHECKLIST_pre-hst2) |

> **Notă:** documente duplicate prin versiuni sunt listate separat — fiecare versiune e document distinct istoric. Total **active** (deprecate excluse, MASTER_PLAN v1.0.0+v1.1.0 supersedat de v1.1.1): **~87** post-S19.
...
4. Refresh manual la fiecare audit checkpoint (post-S12, S13, S14, S15, S16, S17, S18, S19 — acum, S20+).
5. Stil descriere: target 5 rânduri română.
6. Post-S20 HST #2: bump PATCH v1.1.1 (sau MINOR dacă structural changes findings) reflectând outcome HST #2.
...
*docs/INDEX_REVYX_documents_v1.1.0.md · v1.1.0 · 2026-07 · CONFIDENȚIAL · Uz Intern*
