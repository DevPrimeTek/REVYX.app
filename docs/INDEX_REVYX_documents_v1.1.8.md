...
<!-- INDEX_REVYX_documents_v1.1.8.md · v1.1.8 · 2026-05 -->
...
## 12. Document count summary (★ M0.S5 close, v1.1.8)

| Categorie | Count |
|---|---|
| Foundation (CLAUDE.md + brand) | 2 (CLAUDE.md ★ v1.2.11) |
| Strategic Planning | 4 (MASTER_PLAN v1.0.0 [history] + v1.1.0 [history] + v1.1.1 [history] + v1.1.2 active) |
| Platform & Detailed Roadmap | 7 (Roadmap ★ v1.0.5 ACTIVE; v1.0.4/v1.0.3/v1.0.2/v1.0.1 [HISTORY], v1.0.0 [HISTORY-partial]) |
...
| Workflows | 11 |
| Runbooks | 13 |
| Audit + Readiness | 21 (★ +2 HST M0 raport + findings backlog) |
| CS Playbooks + Checklists | 7 |
| Legal | 7 |
| Test fixtures + Templates | 3 |
| Skills | 5 |
| Board reports + Strategic post-GA §15 | 1 |
| **Total** | **131 documente** (★ +3 vs v1.1.7 = Roadmap v1.0.5 PATCH + HST M0 raport + HST M0 findings backlog; CLAUDE.md bump v1.2.10 → v1.2.11 in-place; INDEX v1.1.7 → v1.1.8 in-place). |

> **Notă:** documente duplicate prin versiuni listate separat. **Active** post-M0.S5: **~109** (+1 Roadmap +2 §2e audit artefacte vs M0.S4).
