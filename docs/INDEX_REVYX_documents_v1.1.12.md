...
<!-- INDEX_REVYX_documents_v1.1.12.md · v1.1.12 · 2026-05 -->
...
| ★ `docs/ROADMAP_REVYX_detailed-execution_v1.0.8.md` | NEW M0.S6 — **PATCH M0.S6 ✅ CLOSED Demo Polish (UI-only).** §3.6 T-M0.S6-01..08 marcaje ☑. Output `apps/web-preview/`: i18n 254 keys/limbă rescris, 4 new pages (tutorial + 3 cabinete + property detail), 2 new helpers (info-tooltip + freshness), 8 pages rewritten, formule complet ascunse în UI. Backend `apps/api/` + BRD §7 + scoring fixtures INTACTE. Tests typecheck/lint/build PASS 20 routes. Backwards compat full cu v1.0.7. Versiunea **activă**. Owner: DESIGNER (Creative Director, P) + FRONTEND WEB DEV (P) + ARCHITECT (S) + DOC + Senior PM. |
