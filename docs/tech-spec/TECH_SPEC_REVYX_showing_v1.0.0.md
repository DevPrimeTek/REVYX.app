...
|---|---|---|
| BRD_REVYX_v1.0.0.md | None | Schema BRD §8 implementată extensiv |
| TECH_SPEC_REVYX_lead-scoring_v1.0.0.md | Minor | Counter `consecutive_no_show_count` consumat indirect via LEAD field |
| TECH_SPEC_REVYX_audit-log_v1.0.0.md | Minor | Catalog event extins (`SHOWING_*`, `WHATSAPP_TEMPLATE_FAILED`) |
