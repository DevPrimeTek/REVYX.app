...
<!-- ROADMAP_REVYX_detailed-execution_v1.0.6.md · v1.0.6 · 2026-05 -->
...
> Neschimbat față de v1.0.0. Note: T-M1.S5-01 ("Reuse design system din M0.S1 + tokens") rămâne valid și beneficiază acum de `design/tokens.json` + `apps/web-preview/components/ui/` deja stabilizate. T-M1.S2 entry deblocat post M1.S1 ☑.
