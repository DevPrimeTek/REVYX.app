...
Format: `T-<MILESTONE>.<SUBSTAGE>-<INDEX>` (ex: `T-M1.S2-03`). Listate per sub-stage în `ROADMAP_REVYX_detailed-execution_v1.0.10.md`. Total: ~308 tasks · ~122-164 sesiuni estimate.
...
| **INDEX** | Document Catalog | `docs/INDEX_*.md` | `INDEX_REVYX_documents_v1.1.16.md` (living catalog 11 categorii) |
...
| **ROADMAP** | Detailed atomic tasks | `docs/ROADMAP_*.md` | `ROADMAP_REVYX_detailed-execution_v1.0.10.md` |
...
| `docs/ROADMAP_REVYX_detailed-execution_v1.0.10.md` | T-XXX atomic tasks · Mkt-M1 marketing track |
| `docs/INDEX_REVYX_documents_v1.1.16.md` | Catalog documente · changelog historic |
...
- T-XXX listing nu este exhaustiv aici (308+ tasks) — sursă autoritativă rămâne ROADMAP v1.0.10.
