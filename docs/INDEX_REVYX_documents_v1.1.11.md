...
<!-- INDEX_REVYX_documents_v1.1.11.md · v1.1.11 · 2026-05 -->
...
| ★ `docs/ROADMAP_REVYX_detailed-execution_v1.0.7.md` | NEW M1.S2 — **PATCH M1.S2 ✅ CLOSED Phase A Foundation**. §4.2 T-M1.S2-01..06 marcaje ☑. Output: 9 migrations SQL 0007-0015 + 9 Drizzle schemas + 7 REST modules sub `apps/api/src/business/` + scoring fixtures T01..T07 + integration test infra testcontainers-postgres + CI job nou. Tests 22/22 PASS. Backwards compat full cu v1.0.6. Versiunea **activă**. Owner: BACKEND DEV (P) + DBA (P) + ARCHITECT (S) + TESTER (S) + DOC + Senior PM. |
