...
<!-- INDEX_REVYX_documents_v1.1.14.md · v1.1.14 · 2026-05 -->
...
| ★ `docs/ROADMAP_REVYX_detailed-execution_v1.0.9.md` | NEW M0.S7 — **PATCH M0.S7 ✅ CLOSED Dashboard rework + task management + lead notes/documents + cabinet enrichment.** §3.7 T-M0.S7-01..09 marcaje ☑. Output `apps/web-preview/`: NEW /tasks page + 5 reusable components + 4 stores/data + dashboard 6 blocuri + lead detail Notes/Documents + cabinet agent enrichment. i18n extins +143 keys (task/leadExtras/cabinetExtras namespaces). Backend `apps/api/` + framework specs INTACTE — primitives reused 1:1. Tests typecheck/lint/build PASS 21 routes. Backwards compat full cu v1.0.8. Versiunea **activă**. Owner: DESIGNER (Creative Director, P) + FRONTEND WEB DEV (P) + ARCHITECT (S, framework alignment) + DOC + Senior PM. |
...
| Document | Descriere |
|---|---|
| `docs/BRD_REVYX_v1.1.0.md` | Business Requirements Document v1.0 — piloni, formule scoring, RBAC 5 roluri, T01-T07. Owner: PM Lead. |
