...
<!-- READINESS_REVYX_phase5_v1.0.0.md · v1.0.0 · 2026-05 -->
...
| # | Gate | Sursă spec | Status @ S12 | Owner | Blocker active | Sign-off | Data sign-off |
|---|---|---|---|---|---|---|---|
| 0.1 | DPIA Phase 5 sign-off triple (DPO + Security Lead + CISO) | `DPIA_REVYX_phase5` v1.0.0 §10 | 🟢 GREEN | DPO | — | ☐ | __ |
| 0.2 | Audit S11 findings F-S10-01..03, F-S10-05, F-S10-06, F-S10-10 closed | `AUDIT_REVYX_s11-external-pass` v1.0.0 §2.1 | 🟢 GREEN | Audit Lead | — | ☐ | __ |
| 0.3 | Audit S11 findings tracked S12 (F-S10-04, F-S10-08, F-S10-09) closed via inline | `AUDIT_REVYX_s11-external-pass` v1.0.0 §7 | 🟢 GREEN (inline S12 acum) | Audit Lead | — | ☐ | __ |
...
| 0.6 | `audit-catalog-lint` workflow live (script `.mjs` activat la primul cod aplicație) | `.github/workflows/audit-catalog-lint.yml` | 🟢 GREEN (workflow); 🟡 script Phase 0 dev kickoff | Senior QA | — | ☐ | __ |
| 0.7 | Stripe products + price catalog REAL (marketplace plan + WL Enterprise addon) | external | 🔴 PENDING | Billing Lead | (operational) | ☐ | __ |
...
| 0.13 | All Phase 5 specs frozen ≥7 zile (no changes pe specs) | git log | 🟡 (S12 deliverables this sprint; freeze de la T-7d) | PM Lead | — | ☐ | __ |
| 0.14 | ★ Vendor SCC files signed: Apple FCM + Google Push (F-S11-03) | DPIA §3.1 Art. 44+ | 🔴 PENDING | DPO + Legal | — | ☐ | __ |
...
| CTO | Stabilitate tehnică (NFR + S11 audit closed) | Aprobă tehnic | Утверждает технически | Approves technically | ☐ | __ |
...
|---|---|---|---|---|---|---|---|
| 1.1 | App Store Connect: build TestFlight uploaded + privacy questionnaire submitted | mobile-rn §16 | ☐ | Mobile Lead | — | ☐ | __ |
...
| 1.5 | Backend `MOBILE_DEVICE_*` + `AUTH_MOBILE_OT_*` events live | audit-log v1.1.0 §4.4.4 | ☐ | Backend Lead | — | ☐ | __ |
| 1.6 | OT flow rate-limited per ISO 27001 controls | iso27001-track | ☐ | Security Lead | — | ☐ | __ |
| 1.7 | Cohort selectat (25 interni + 25 externi) | CS | ☐ | CS Lead | — | ☐ | __ |
| 1.8 | ★ SCC Apple FCM + Google Push on file (F-S11-03) | DPIA Art. 44+ | ☐ | DPO + Legal | (gating) | ☐ | __ |
...
| 2.8 | Stripe products + plan-tier gating verificat | Billing | ☐ | Billing Lead | (operational from §2.0.7) | ☐ | __ |
...
| Audit Lead | S11/S12/S13 audit checkpoints PASS | ☐ | __ |
...
## 12. Approval (acest document v1.0.0)
...
*docs/audit/READINESS_REVYX_phase5_v1.0.0.md · v1.0.0 · 2026-05 · CONFIDENȚIAL · Uz Intern*
