...
// Backend va citi același pattern via FK transaction_profile_id pe LEAD/DEAL.

import type { Lead, LeadType, TransactionIntent, LeadSide, ListingType } from '@/lib/mock';
...
export function isListingMatchForLead(lead: Pick<Lead, 'leadType'>, listingType: ListingType): boolean {
