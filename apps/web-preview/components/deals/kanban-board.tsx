...
function DealCard({
  ...
  return (
    ...
    >
      ...
      <div className="px-1.5 pt-1.5 pb-1.5 flex items-center justify-between gap-sp2 min-w-0">
      ...
      {!isDragOverlay && (
        <>
          <div className="h-px bg-border mx-1.5" />
          <div className="px-1.5 py-1.5 flex items-center justify-between gap-x-sp2 min-w-0">
